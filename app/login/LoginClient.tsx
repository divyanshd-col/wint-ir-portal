      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="px-8 py-8">
            ...
            <p className="text-gray-500 text-sm mb-6">Sign in with your Wint Wealth Google account</p>

            {error && (
              <div className="bg-red-50 border border-red-200 text-red-600 text-sm px-4 py-3 rounded-lg mb-4">
                {error === 'AccessDenied'
                  ? 'Access denied. Only @wintwealth.com accounts are allowed.'
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold py-3 rounded-xl transition shadow-sm text-sm"
            >
              {/* Google logo */}
