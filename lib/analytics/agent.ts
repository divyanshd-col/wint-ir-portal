...
// Fallback: gemini-3.5-flash (only on timeout — fully transparent to the user)

const PRIMARY_MODEL  = 'gemini-3.5-flash';
const FALLBACK_MODEL_ANALYTICS = 'gemini-3.5-flash';
...
async function geminiWithFallback(
  ...
  try {
    ...
    console.warn('[analytics/agent] gemini-3.5-flash timed out — retrying with fallback');
